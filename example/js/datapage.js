...
* @des:翻页
* @Author: wei jundong
* @Date:   2017-05-25 15:15:39
* @Last Modified by:   wei jundong
* @Last Modified time: 2017-05-25 17:38:16
*/
...
function weify(udata,key){
              ...
              Allpage.children[yi].onclick=(function(index){
                return function(){
                     nowpage= Number(Allpage.children[index].innerText);
                      ...
                      if(index==0 && Allpage.children[index].innerText!=1){isUpym=2;} 
                     Optpage('toPage');
                }
            })(yi);
  ...
  //下拉框搜索
  var tempselect=document.createDocumentFragment();//碎片
