...
Drag.prototype = {
  ...
  startDrag: function(event){
    ...
    this.handle.setCapture && event.handle.setCapture();
  ...
  //添加绑定事件
  addHandler: function(oElment, sEventType, fnHandler){
    return oElment.addEventListener ? oElment.addEventListener(sEventType, fnHandler, false):oElment.attachEvent("on"+sEventType, fnHandler)
  },
  //删除绑定事件
  removeHandler: function(oElment, sEventType, fnHandler) {
    return oElment.removeEventListener ? oElment.removeEventListener(sEventType, fnHandler, false):oElment.detachEvent("on"+sEventType, fnHandler)
  },
  //绑定事件到对象
