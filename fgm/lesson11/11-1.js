  ...
  css: function(element, attr, value) {
    if(arguments.length == 2) {
      ...
      for(var property in attr)
        property == "opacity" ? (style.filter = "alpha(opacity=" + attr[property]+")",style.opacity = attr[property]/100) :
        style[property] = attr[property]
      ...
      for(property in json) {
        ...
        switch(opt.type) {
          case "buffer":
            ...
            json[property] == iCur || (complete = !1, fgm.css(obj,property,property == "zIndex"?
              iCur+obj.iSpeed || iCur * -1 : iCur + obj.iSpeed));
            break;
          case "flex":
            obj.iSpeed += (json[property] - iCur) / 5;
            obj.iSpeed *= 0.7;
            obj.iSpeed = Math.abs(obj.iSpeed) > maxSpeed ? obj.iSpeed > 0 ? maxSpeed: -maxSpeed : obj.iSpeed;
            Math.abs(json[property] - iCur) <= 1 && Math.abs(obj.iSpeed) <= 1 ||
            (complete = !1, fgm.css(obj, property, iCur+obj.iSpeed));
            break;
        }
      }
      if(complete) {
...
function complete() {
  var oBox = fgm.$("box"),
      ...
      oRight = fgm.$("right"),
      oLMask = fgm.$$$("mask",oLeft)[0],
      oRMask = fgm.$$$("mask",oRight)[0],
